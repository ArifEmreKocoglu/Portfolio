...
import detailImage from '../img/1_10074.jpg';
function DetailBlog() {
    return (
        <div>
           
       <section className="home section bd_grid" id="detailBlog">
           <div className="detailsBaslik">
                <img src={ detailImage } alt="" className="detailImage"></img>
           </div>
           <div className="details">
               <div className="baslık"><h1>Psikoloji</h1></div>
                <p>Lorem Ipsum Nedir?
